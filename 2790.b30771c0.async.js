"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[2790],{95676:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(3837),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},3837:function(e,n,r){r.r(n)},29326:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},1016:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},92724:function(e,n){n.Z=`import React from 'react'
...
`},22495:function(e,n){n.Z=`import type { FC, ReactNode } from 'react';
...
`},99937:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},43287:function(e,n){n.Z=`import React from 'react'
...
`},87301:function(e,n){n.Z=`import React from 'react'
...
`},92915:function(e,n){n.Z=`import React from 'react'
...
`},11452:function(e,n){n.Z=`import React from 'react'
  ...
  >
    ...
    <g fill='none' fillRule='evenodd'>
      ...
      <g transform='translate(108.571 189.886)'>
        <mask id='error-block-image-empty-c' fill='#fff'>
          <use xlinkHref='#error-block-image-empty-b' />
        </mask>
        <use fill='#377EFF' xlinkHref='#error-block-image-empty-b' />
        <path
      ...
      <path
        ...
        fillRule='nonzero'
      />
      <g transform='translate(283.429 177.143)' fillRule='nonzero'>
        <path
        ...
        <path
          ...
          fill='#FFCD6B'
        />
        <circle fill='#FFB400' cx={26.4} cy={56.869} r={1.45} />
        <circle fill='#FFB400' cx={39.453} cy={58.319} r={1} />
        <circle fill='#FFB400' cx={17.698} cy={63.637} r={2.417} />
        <circle fill='#FFB400' cx={38.002} cy={51.068} r={2.417} />
        <circle fill='#FFB400' cx={18.665} cy={17.228} r={2.417} />
        <circle fill='#FFB400' cx={32.201} cy={13.36} r={2.417} />
        <circle fill='#FFB400' cx={26.83} cy={20.666} r={1.45} />
        <circle fill='#FFB400' cx={38.969} cy={31.731} r={2.417} />
        <circle fill='#FFB400' cx={25.433} cy={29.797} r={1.45} />
        <path
...
`},69735:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},4614:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},45610:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},89083:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},55052:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},27930:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},62586:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

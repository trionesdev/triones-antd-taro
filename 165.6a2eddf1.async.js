"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[165],{49387:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(91518),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},91518:function(e,n,r){r.r(n)},32065:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},56:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},7761:function(e,n){n.Z=`import React from 'react'
...
`},84282:function(e,n){n.Z=`import React from 'react'
...
`},1130:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},4009:function(e,n){n.Z=`import React from 'react'
...
`},79905:function(e,n){n.Z=`import React from 'react'
...
`},17779:function(e,n){n.Z=`import React from 'react'
...
`},85871:function(e,n){n.Z=`import React from 'react'
...
`},67928:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},69155:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},97297:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},55033:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},87770:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},12636:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},62055:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

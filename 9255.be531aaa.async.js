"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[9255],{49387:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(91518),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},91518:function(e,n,r){r.r(n)},13512:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},54174:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},28667:function(e,n){n.Z=`import React from 'react'
...
`},18058:function(e,n){n.Z=`import React from 'react'
...
`},32607:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},87132:function(e,n){n.Z=`import React from 'react'
...
`},46673:function(e,n){n.Z=`import React from 'react'
...
`},42749:function(e,n){n.Z=`import React from 'react'
...
`},72141:function(e,n){n.Z=`import React from 'react'
...
`},44075:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},74994:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},87429:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},56141:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},74611:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},40013:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},51553:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

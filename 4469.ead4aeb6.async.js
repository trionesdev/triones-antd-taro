"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[4469],{57180:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(56368),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},56368:function(e,n,r){r.r(n)},53551:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},18199:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},48873:function(e,n){n.Z=`import React from 'react'
...
`},36206:function(e,n){n.Z=`import React from 'react'
...
`},19442:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},11821:function(e,n){n.Z=`import React from 'react'
...
`},78167:function(e,n){n.Z=`import React from 'react'
...
`},91279:function(e,n){n.Z=`import React from 'react'
...
`},27641:function(e,n){n.Z=`import React from 'react'
...
`},69606:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},96498:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},48562:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},33548:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},12526:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},21404:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},57954:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

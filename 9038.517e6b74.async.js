"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[9038],{57180:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(56368),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},56368:function(e,n,r){r.r(n)},51236:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},5166:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},6682:function(e,n){n.Z=`import React from 'react'
...
`},19824:function(e,n){n.Z=`import React from 'react'
...
`},64258:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},39889:function(e,n){n.Z=`import React from 'react'
...
`},51154:function(e,n){n.Z=`import React from 'react'
...
`},30096:function(e,n){n.Z=`import React from 'react'
...
`},87471:function(e,n){n.Z=`import React from 'react'
...
`},37363:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},93481:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},48444:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},32360:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},74580:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},43789:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},45876:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

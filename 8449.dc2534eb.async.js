"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[8449],{42611:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(30565),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},30565:function(e,n,r){r.r(n)},13696:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},38767:function(e,n){n.Z=`import React from 'react'
...
`},96586:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},87016:function(e,n){n.Z=`import React from 'react'
...
`},24199:function(e,n){n.Z=`import React from 'react'
...
`},56867:function(e,n){n.Z=`import React from 'react'
...
`},42334:function(e,n){n.Z=`import React from 'react'
...
`},54524:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},26478:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},71543:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},60484:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'

"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[533],{62901:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(22811),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},22811:function(e,n,r){r.r(n)},6425:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},61418:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},46875:function(e,n){n.Z=`import React from 'react'
...
`},10206:function(e,n){n.Z=`import React from 'react'
...
`},59900:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},90597:function(e,n){n.Z=`import React from 'react'
...
`},64978:function(e,n){n.Z=`import React from 'react'
...
`},34714:function(e,n){n.Z=`import React from 'react'
...
`},88829:function(e,n){n.Z=`import React from 'react'
...
`},59143:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},45936:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},41058:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},23867:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},45900:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},72621:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},19065:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

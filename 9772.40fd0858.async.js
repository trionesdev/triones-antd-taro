"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[9772],{95676:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var i=r(44194),c=r(3837),t=r(31549),a=function(o){return(0,t.jsxs)("div",{className:"demoBlock",children:[(0,t.jsx)("div",{className:"demoTitle",children:o.title}),(0,t.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:o.children})]})}},3837:function(e,n,r){r.r(n)},7003:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},77563:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},87669:function(e,n){n.Z=`import React from 'react'
...
`},55903:function(e,n){n.Z=`import type { FC, ReactNode } from 'react';
...
`},95801:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},32526:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},38864:function(e,n){n.Z=`import {CSSProperties, FC, ReactNode, useMemo} from 'react'
import React from 'react'
import classNames from 'classnames'
import './style.scss'
...
`},5515:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},8196:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},65458:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

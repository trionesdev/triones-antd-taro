"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[488],{62901:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(22811),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},22811:function(e,n,r){r.r(n)},74002:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},77784:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},70143:function(e,n){n.Z=`import React from 'react'
...
`},20292:function(e,n){n.Z=`import React from 'react'
...
`},55726:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},44608:function(e,n){n.Z=`import React from 'react'
...
`},90994:function(e,n){n.Z=`import React from 'react'
...
`},99369:function(e,n){n.Z=`import React from 'react'
...
`},30128:function(e,n){n.Z=`import React from 'react'
...
`},38826:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},32465:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},25004:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},75058:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},28609:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},64090:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},63421:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[1961],{72982:function(e,n,t){t.r(n),t.d(n,{DemoBlock:function(){return a}});var i=t(44194),s=t(14368),o=t(31549),a=function(r){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:r.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:r.children})]})}},14368:function(e,n,t){t.r(n)},13400:function(e,n){n.Z=`import "./style.scss"
...
`},11001:function(e,n){n.Z=`import {Button, ButtonProps} from "./button";

export type {ButtonProps}
export default Button
`},79136:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},48722:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},78344:function(e,n){n.Z=`import React from 'react'
...
`},83717:function(e,n){n.Z=`import { animated, useSpring } from '@react-spring/web';
...
`},25139:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},4352:function(e,n){n.Z=`export const canUseDom = !!(
  typeof window !== 'undefined' &&
  typeof document !== 'undefined' &&
  window.document &&
  window.document.createElement
);
`},60081:function(e,n){n.Z=`export type GetContainer = () => HTMLElement;
...
`},96111:function(e,n){n.Z=`import { canUseDom } from './can-use-dom';
...
`},47254:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},8464:function(e,n){n.Z=`import type { ReactElement, ReactPortal } from 'react';
...
`},34456:function(e,n){n.Z=`import type { FC, ReactElement } from 'react';
...
`},86079:function(e,n){n.Z=`import { canUseDom } from './can-use-dom';
...
`},30990:function(e,n){n.Z=`import { useRef } from 'react';
...
`},72700:function(e,n){n.Z=`import { RefObject, useEffect } from 'react';
...
`},20365:function(e,n){n.Z=`import { useRef } from 'react';
...
`},36941:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;
...
`},84525:function(e,n){n.Z=`import React from 'react'

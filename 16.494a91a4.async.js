"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[16],{72982:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(14368),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},14368:function(e,n,r){r.r(n)},64859:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},70053:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},92107:function(e,n){n.Z=`import React from 'react'
...
`},53228:function(e,n){n.Z=`import React from 'react'
...
`},70336:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},39317:function(e,n){n.Z=`import React from 'react'
...
`},26521:function(e,n){n.Z=`import React from 'react'
...
`},42923:function(e,n){n.Z=`import React from 'react'
...
`},14684:function(e,n){n.Z=`import React from 'react'
...
`},29643:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},64738:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},8797:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},83482:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},54078:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},26329:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},49231:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

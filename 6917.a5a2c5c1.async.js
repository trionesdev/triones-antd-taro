"use strict";(self.webpackChunk_trionesdev_antd_taro_react=self.webpackChunk_trionesdev_antd_taro_react||[]).push([[6917],{72982:function(e,n,r){r.r(n),r.d(n,{DemoBlock:function(){return a}});var l=r(44194),c=r(14368),o=r(31549),a=function(t){return(0,o.jsxs)("div",{className:"demoBlock",children:[(0,o.jsx)("div",{className:"demoTitle",children:t.title}),(0,o.jsx)("div",{className:"demoMain",style:{padding:"12px 12px",background:"#ffffff"},children:t.children})]})}},14368:function(e,n,r){r.r(n)},45339:function(e,n){n.Z=`import React, { FC, ReactNode, useContext } from 'react'
...
`},796:function(e,n){n.Z=`import { ConfigProvider } from './config-provider'
...
`},96530:function(e,n){n.Z=`import React from 'react'
...
`},72337:function(e,n){n.Z=`import React from 'react'
...
`},43519:function(e,n){n.Z=`import { createErrorBlock } from './create-error-block'
...
`},75571:function(e,n){n.Z=`import React from 'react'
...
`},78863:function(e,n){n.Z=`import React from 'react'
...
`},47859:function(e,n){n.Z=`import React from 'react'
...
`},96271:function(e,n){n.Z=`import React from 'react'
...
`},79856:function(e,n){n.Z=`export { defaultImage } from './default'
export { disconnectedImage } from './disconnected'
export { emptyImage } from './empty'
export { busyImage } from './busy'
`},35639:function(e,n){n.Z=`import type { ReactNode } from 'react'
...
`},41056:function(e,n){n.Z=`import { Space } from './space'

export type { SpaceProps } from './space'

export default Space
`},97824:function(e,n){n.Z=`import React from 'react'
import type { FC, ReactNode } from 'react'
import classNames from 'classnames'
import { NativeProps, withNativeProps } from '../utils/native-props'
import './style.scss'
...
`},25786:function(e,n){n.Z=`import { Locale } from './base'
...
export default zhCN
`},96878:function(e,n){n.Z=`import React, { AriaAttributes } from 'react'
...
`},55291:function(e,n){n.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;

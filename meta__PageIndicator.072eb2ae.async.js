...
`},92107:function(o,t){t.Z=`import React from 'react'
...
`},54245:function(o,t){t.Z=`import { DemoBlock } from '../../DemoBlock';
...
`},16281:function(o,t){t.Z=`import { PageIndicator } from './page-indicator'

export type { PageIndicatorProps } from './page-indicator'

export default PageIndicator
`},39785:function(o,t){t.Z=`import React, { memo } from 'react'
...
`},85539:function(o,t){t.Z=`.triones-antm-page-indicator {
  display: flex;
  width: auto;
...
`},26329:function(o,t){t.Z=`import React, { AriaAttributes } from 'react'
...
`},49231:function(o,t){t.Z=`export function mergeProps<A, B>(a: A, b: B): B & A;
